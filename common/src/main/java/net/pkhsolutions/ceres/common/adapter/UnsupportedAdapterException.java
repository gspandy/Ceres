...
public class UnsupportedAdapterException extends IllegalArgumentException {
    ...
    /**
     * Constructs a new
     * <code>UnsupportedAdapterException</code>.
     */
     ...
     * <code>UnsupportedAdapterException</code>.
     *
     * @param adapterClass the unsupported adapter class, must not be
     * null.
     */
    ...
    /**
     * Gets the adapter class that was not supported, if available.
     *
     * @return the adapter class, or null if no class was provided.
     */
