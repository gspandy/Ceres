 ...
 * @since 1.0
 */
@Buildable(populationStrategy = Buildable.DataPopulationStrategy.USE_FIELDS, bindable = true)
public class ExampleFieldsBindableBuildable extends ExampleFieldsBuildable {
}
